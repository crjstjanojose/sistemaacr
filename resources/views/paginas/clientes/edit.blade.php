...
<form action="{{ route('clientes.update',$cliente->id) }}" method="post">
    ...
    <div class="form-row mt-3">
        ...
        <div class="form-group col-md-8">
            <input type="text" class="form-control @error('nome') is-invalid @enderror" id="nome" name="nome" required
                value="{{ old('nome') ?? $cliente->nome }}" placeholder="Nome do Cliente">
        ...
        <div class="form-group col-md-2">
            <input type="text" name="nascimento" id="nascimento"
                class="form-control @error('nascimento') is-invalid @enderror" placeholder=" 99/99/9999"
                required value="{{ old('nascimento') ?? $cliente->nascimento }}">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-2">
            <input type="text" class="form-control @error('cpf') is-invalid @enderror" id="cpf" name="cpf" required
                value="{{ old('cpf') ?? $cliente->cpf }}" placeholder="CPF">
        ...
        <div class="form-group col-md-2">
            <input type="text" class="form-control @error('rg') is-invalid @enderror" id="rg" name="rg" required
                value="{{ old('rg') ?? $cliente->rg }}" placeholder="RG">
        ...
        <div class="form-group col-md-2">
            <input type="text" class="form-control @error('celular') is-invalid @enderror" id="celular" name="celular"  required
        ...
        <div class="form-group col-md-2">
            <input type="text" class="form-control @error('telefone') is-invalid @enderror" id="telefone" name="telefone"
                value="{{ old('telefone') ?? $cliente->telefone }}" placeholder="Telefone">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            <input type="text" class="form-control @error('endereco') is-invalid @enderror" id="endereco" name="endereco" required
                value="{{ old('endereco') ?? $cliente->endereco }}" placeholder="Endereço">
        ...
        <div class="form-group col-md-3">
            <input type="text" class="form-control @error('bairro') is-invalid @enderror" id="bairro" name="bairro" required
                value="{{ old('bairro') ?? $cliente->bairro }}" placeholder="Bairro">
        ...
        <div class="form-group col-md-2">
            <select name="cidade_id" id="cidade_id" class="form-control @error('cidade') is-invalid @enderror">
                ...
                <option value="{{ $cidade->id }}" {{ $cliente->cidade_id == $cidade->id ? 'selected' : '' }} >{{ $cidade->descricao }}</option>
                @endforeach
            </select>
